...
return [
    ...
    'timestamp' => 1509974528,
    'checksum' => '6ab22c43cbd29f4aa718d2f23bdb4088',
    'files' => [
        'user/data/gantry5/themes/g5_helium/config/about' => [
            'assignments' => [
                'file' => 'user/data/gantry5/themes/g5_helium/config/about/assignments.yaml',
                'modified' => 1500344594
            ],
            'index' => [
                'file' => 'user/data/gantry5/themes/g5_helium/config/about/index.yaml',
                'modified' => 1509972118
            ],
            'layout' => [
                'file' => 'user/data/gantry5/themes/g5_helium/config/about/layout.yaml',
                'modified' => 1507512852
            ]
        ],
  ...
  "content": {
    "href": "http://questionsforinterviewer.com/privacypolicy"
        ...
        'index' => [
            ...
            'particles' => [
                'logo' => [
                    'logo-5972' => 'Tomasz - picture',
                    'logo-3022' => 'Logo / Image'
                ],
                'content' => [
                    'system-content-1587' => 'Page Content'
                ],
                'custom' => [
                    'custom-8406' => 'Custom HTML',
                    'custom-4038' => 'Call to action',
                    'custom-2526' => 'Subscribe',
                    'custom-6926' => 'Social media liks'
                ],
                'messages' => [
                    'system-messages-8582' => 'System Messages'
                ],
                'menu' => [
                    'menu-3789' => 'Menu'
                ],
                ...
                'position' => [
                    'position-position-9916' => 'Aside',
                    'position-position-3207' => 'Sidebar'
                ],
                'mobile-menu' => [
                    'mobile-menu-6922' => 'Mobile-menu'
                ],
                'horizontalmenu' => [
                    'horizontalmenu-6405' => 'Horizontal Menu'
                ],
                'copyright' => [
                    'copyright-1441' => 'Copyright'
                ]
            ],
            'inherit' => [
                'home_page' => [
                    ...
                    'sidebar' => 'sidebar',
                    'offcanvas' => 'offcanvas',
                    'system-messages-8582' => 'system-messages-7972',
                    'logo-3022' => 'logo-9608',
                    'menu-3789' => 'menu-6409',
                    'social-6265' => 'social-3171',
                    'position-position-9916' => 'position-position-4734',
                    'position-position-3207' => 'position-position-3949',
                    'mobile-menu-6922' => 'mobile-menu-5697'
                ],
                'default' => [
                    'footer' => 'footer',
                    'custom-4038' => 'custom-5869',
                    'custom-2526' => 'custom-5624',
                    'custom-6926' => 'custom-3406',
                    'horizontalmenu-6405' => 'horizontalmenu-9737',
                    'copyright-1441' => 'copyright-1736'
                ]
            ]
        ],
        'layout' => [
