...
return [
    ...
    'timestamp' => 1509446067,
    'checksum' => '92a930d5067ea4e59d757abe960b1111',
    'files' => [
        'user/themes/g5_helium/custom/particles' => [
            'particles/article' => [
                'file' => 'user/themes/g5_helium/custom/particles/article.yaml',
                'modified' => 1499753454
            ],
            'particles/horizontalmenu' => [
                'file' => 'user/themes/g5_helium/custom/particles/horizontalmenu.yaml',
                'modified' => 1507512620
            ]
        ],
    ...
    'data' => [
        'items' => [
            ...
            'particles.article.enabled' => [
                'type' => 'input.checkbox',
                'label' => 'Enabled',
                'description' => 'Globally enable to the particles.',
                'default' => true,
                'name' => 'particles.article.enabled'
            ],
            'particles.article.bg' => [
                'type' => 'input.text',
                'label' => 'Article background color - CSS class',
                'description' => 'Article background color - CSS class',
                'name' => 'particles.article.bg'
            ],
            'particles.article.highlight' => [
                'type' => 'input.text',
                'label' => 'Question highlight color - CSS class',
                'description' => 'Question highlight color - CSS class',
                'name' => 'particles.article.highlight'
            ],
            'particles.article.image' => [
                'type' => 'input.text',
                'label' => 'Image name',
                'description' => 'Image file name',
                'name' => 'particles.article.image'
            ],
            'particles.article.question' => [
                'type' => '_parent',
                'name' => 'particles.article.question',
                'form_field' => false
            ],
            'particles.article.question.number' => [
                'type' => 'input.text',
                'label' => 'Question number',
                'description' => 'Question number',
                'name' => 'particles.article.question.number'
            ],
            'particles.article.question.title' => [
                'type' => 'input.text',
                'label' => 'Title',
                'description' => 'Title',
                'name' => 'particles.article.question.title'
            ],
            'particles.article.html' => [
                'type' => 'textarea.textarea',
                'label' => 'Text / HTML',
                'description' => 'Article text in HTML format.',
                'overridable' => false,
                'name' => 'particles.article.html'
            ],
            'particles.horizontalmenu' => [
                'type' => '_root',
                'form_field' => false,
            ...
            'particles.horizontalmenu.items.*.onclick' => [
                'type' => 'input.text',
                'label' => 'Onclick',
                'name' => 'particles.horizontalmenu.items.*.onclick'
            ],
            'particles.contentcubes' => [
                'type' => '_root',
                'form_field' => false,
        ...
        'nested' => [
            'particles' => [
                'article' => [
                    'enabled' => 'particles.article.enabled',
                    'bg' => 'particles.article.bg',
                    'highlight' => 'particles.article.highlight',
                    'image' => 'particles.article.image',
                    'question' => [
                        'number' => 'particles.article.question.number',
                        'title' => 'particles.article.question.title'
                    ],
                    'html' => 'particles.article.html'
                ],
                'horizontalmenu' => [
                    ...
                    'items' => [
                        '*' => [
                            ...
                            'onclick' => 'particles.horizontalmenu.items.*.onclick'
                        ]
                    ]
                ],
                'contentcubes' => [
