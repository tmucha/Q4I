...
return [
    ...
    'timestamp' => 1510047006,
    'checksum' => '93b1c2d97b7d754b55687708c0d54e02',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/urlparamfilter' => [
                'file' => 'user/plugins/urlparamfilter/blueprints.yaml',
                'modified' => 1510046462
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'plugins.urlparamfilter.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin status',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.urlparamfilter.enabled',
                'validation' => 'strict'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'urlparamfilter' => [
                    'enabled' => 'plugins.urlparamfilter.enabled'
                ]
            ]
        ],
        'dynamic' => [
